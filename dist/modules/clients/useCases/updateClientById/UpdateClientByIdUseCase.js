...
exports.UpdateClientByIdUseCase = void 0;
...
let UpdateClientByIdUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    if (!(0, _ensureId.ensureId)(id)) {
      throw new _AppError.AppError("Service Executed not found", 401);
    }
    ...
    if (checkClientIdExists.name !== name) {
      ...
      if (checkClientNameExists) {
        throw new _AppError.AppError("Name already exists", 401);
      }
    }
...
exports.UpdateClientByIdUseCase = UpdateClientByIdUseCase;