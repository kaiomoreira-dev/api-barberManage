...
exports.ListServiceExecutedByClientIdUseCase = void 0;
...
let ListServiceExecutedByClientIdUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute(idClients) {
    ...
    const servicesExecuted = await this.serviceExecutedRepository.listByClientsId(idClients);
...
exports.ListServiceExecutedByClientIdUseCase = ListServiceExecutedByClientIdUseCase;