...
exports.UpdateCostByIdUseCase = void 0;
...
let UpdateCostByIdUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    if (!checkCostExists) {
      throw new _AppError.AppError("Cost not found", 401);
    }
...
exports.UpdateCostByIdUseCase = UpdateCostByIdUseCase;